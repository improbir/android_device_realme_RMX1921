...
#Vendor Tree
git clone https://github.com/improbir/vendor_realme_RMX1921.git -b 13 vendor/realme/RMX1921 
...
#Display hal
git clone https://github.com/LineageOS/android_hardware_qcom_display.git -b lineage-20.0-caf-sdm845 hardware/qcom-caf/sdm845/display
